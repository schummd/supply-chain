...
CREATE TABLE `product` (
  ...
  `required_conditions` varchar(45) NOT NULL,
...
INSERT INTO `product` VALUES (1,300,'2021-07-18','true','cold',123),(2,200,'2021-08-20','true','cold',234),(3,1000,'2022-01-02','true','regular',123);
