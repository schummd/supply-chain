...
contract('Product', (accounts) => {
    ...
    it('Sending data through oracle', async () => {
        let res = await productInstance.getTemperature(batchID);
        // let res = await productInstance.receiveTemperatureFromOracle.call(batchID, 4,productInstance.address, {from: oracleOwner});
        assert.isTrue(res);
    });
