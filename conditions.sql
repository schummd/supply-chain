...
CREATE TABLE `conditions` (
  ...
  `reqTemperature` float NOT NULL,
  PRIMARY KEY (`batch_id`),
  UNIQUE KEY `batch_id_UNIQUE` (`batch_id`),
  CONSTRAINT `batch_id` FOREIGN KEY (`batch_id`) REFERENCES `product` (`batch_id`)
...
INSERT INTO `conditions` VALUES (1,4,16),(2,2,20),(3,1,26);
...
-- Dump completed on 2022-07-20 14:47:32
